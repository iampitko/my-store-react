        ...
        <Modal.Body>
            <Form>
                <Dropdown className="mt-2 mb-2">
                    <Dropdown.Toggle>{device.selectedType.name || "Виберіть тип пристрою"}</Dropdown.Toggle>
                    <Dropdown.Menu>
                ...
                <Dropdown className="mt-2 mb-2">
                    <Dropdown.Toggle>{device.selectedBrand.name || "Виберіть бренд пристрою"}</Dropdown.Toggle>
                    <Dropdown.Menu>
                ...
                <Form.Control
                    ...
                    className="mt-3"
                    placeholder={"Введіть суму пристрою"}
                    type="number"
                >
                </Form.Control>
                <Form.Control
                    ...
                    <Row className="mt-2" key={i.number}>
                        <Col md={4}>
                            <Form.Control
                                ...
                                placeholder={"Введіть назву параметра"}
                            >
                            </Form.Control>
                        </Col>
                        <Col md={4}>
                            <Form.Control
                                ...
                                placeholder={"Введіть опис параметра"}
                            >
                            </Form.Control>
                        </Col>
                        <Col md={4}>
